    ...
    <div class="container">
                        ...
                        <div class="slick3 gallery-lb">
                            ...
                            <div class="item-slick3" data-thumb="{{ $image->data()['url'] }}">
                                <div class="wrap-pic-w pos-relative">
                                    ...
                                    <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{ $image->data()['url'] }}">
                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                ...
                                <div class="size-204 respon6-next">
                                    <ul>
                                        @foreach ($options as $option)
                                        <li>
                                            <button class="btn btn-outline-primary mt-3" type="button" onclick="setvalue('{{ $option->id() }}')">

                                                <img src="{{ $option->data()['image'] }}" alt="" style="width: 20px;">
                                                {{ $option->data()['name'] }}
                                            </button>
                                        </li>
                                        @endforeach
        ...
        <div>
            <div class="card-footer bor10 m-t-50 p-t-20 p-b-20">
                <div class="media ">
                    <img class="mr-3 rounded-circle" src="{{ $shop['photo'] ?? asset('frontend/images/avatar-01.jpg') }}" alt="Generic placeholder image" style="max-width:50px">
