                ...
                <div class="m-l-25 m-r--38 m-lr-0-xl">
                    <div class="wrap-table-shopping-cart">
                        <table class="table-shopping-cart">
                            ...
                            ->database()
                            ->collection('product');
                            $product = $productRef->document($cart->data()['productId'])
                            ->snapshot();
                            $imgProductRef = $productRef->document($cart->data()['productId'])
                            ->collection('image');
                            $optionProductRef = $productRef->document($cart->data()['productId'])
                            ->collection('option');
                            $images = $imgProductRef
                            ->documents();
                            $option = $optionProductRef
                            ->document($cart->data()['optionProductId'])->snapshot();
                    ...
                    <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                        ...
                        <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
                            ...
                            <div class="p-t-15">
                                ...
                                ->database()
                                ->collection('shippingUnit')->documents();
                                @endphp
