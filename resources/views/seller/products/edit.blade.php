            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Edit Produuct</h3>
                        <a href="{{ route('seller.products.index')}}" class="btn btn-success shadow-sm float-right"> <i class="fa fa-arrow-left"></i> Kembali</a>
                        {{-- <a href="{{ route('seller.products.product_images.index', $product)}}" class="btn btn-success shadow-sm mr-2 float-right"> <i class="fa fa-image"></i> Upload Gambar Produk</a> --}}
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form method="post" action="{{ route('seller.products.update', $product) }}">
                            ...
                            @include('seller.products.configurable')
                            @else
                            @include('seller.products.simple')
                            @endif
